...
_OPERATOR_ALIAS_TABLE: dict = {
    # canonical      aliases
    '==':            ['==', 'is', 'equals', 'equal', 'eq'],
    '!=':            ['!=', 'is_not', 'is not', 'not_equals', 'not_equal', 'not equal', 'ne', 'neq'],
    '<':             ['<', 'lt', 'less_than', 'less than'],
    '<=':            ['<=', 'le', 'less_equal', 'less equal', 'lte'],
    '>':             ['>', 'gt', 'more_than', 'more than', 'greater_than', 'greater than'],
    '>=':            ['>=', 'ge', 'more_equal', 'more equal', 'greater_equal', 'greater equal', 'gte'],
    'contains':      ['contains', 'contain', 'includes', 'include'],
    'starts_with':   ['starts_with', 'starts with', 'startswith', 'start_with', 'start with', 'startwith',
                      'begins_with', 'begins with', 'beginswith', 'begin_with', 'begin with', 'beginwith'],
    'ends_with':     ['ends_with', 'ends with', 'endswith', 'end_with', 'end with', 'endwith'],
    'excludes':      ['excludes', 'exclude', 'not_contains', 'not_contain', 'not contains', 'not contain'],
    'regex':         ['regex', 'regexp', 'matches', 'match', 'regex_match', 'regex matches'],
}
